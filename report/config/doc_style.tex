...
\fancypagestyle{firstpage}{
  ...
  \chead{
      \begin{tabular}{|ccc|r|}
           \hline
           \multirow{11}{*}{\includegraphics[scale=0.13]{images/logo_un.png}} &  &  &  \\
           & {\LARGE Universidad Nacional de Colombia} &  & \textbf{Estudiantes:} \\
           &  &  & Jose Miguel Acuña Hernandez \\
           & {\large Facultad de ciencias} &  & Andres Steven Puertas \\
           &  &  & Guillermo Murillo Tirado \\
           &  {\large Departamento de matemáticas} &  &  \\
           &  &  & \\
           & {\large Derivados de renta variable 2025-I} &  & \textbf{Docente:} \\
           &  &  & Alejandra Sanchez Vásquez \\
           & {\Large Modelo GARCH para la volatilidad} &  & asanchezva@unal.edu.co \\
           &  &  &  \\
           \hline
      \end{tabular}\\
  }
